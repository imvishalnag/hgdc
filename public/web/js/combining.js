                    ...
                    .each(function (t) {
                        if (e("ul", this).length) {
                            var i = e("ul:first", this),
                                ...
                                a = i.width();
                            e("body").height();
                            n + a <= e("body").width() ? e(this).find(".sub-menu:first").removeClass("left") : e(this).find(".sub-menu:first").addClass("left");
                        }
                    });
            }),
            (s = function () {
            ...
            (c = function () {
                e(window).on("scroll", function () {
                    e(".split-box").each(function () {
                        var t, i, n, a, r, o;
                        (t = e(this)), (i = e(t)), (n = e(window)), (a = n.scrollTop()), (r = a + n.height()), (o = i.offset().top) + i.height() <= r && o >= a && e(this).addClass("split-active");
                    });
                });
            }),
                ...
                init: function () {
                    ...
                    jQuery(".box-hover").on("mouseenter", function () {
                        ...
                        jQuery(".dezPlaceAni").length &&
                            (e(".dezPlaceAni input, .dezPlaceAni textarea").on("focus", function () {
                        ...
                        jQuery(document).on("change", ".btn-file :file", function () {
                            var e = jQuery(this),
                                ...
                                i = e.val().replace(/\\/g, "https://smartclass.dexignzone.com/").replace(/.*\//, "");
                        ...
                        jQuery(window).on("scroll", function () {
                            if (jQuery(".sticky-header").length > 0) {
                                ...
                                e(window).scrollTop() > t.offset().top
                                    ? (t.addClass("is-fixed"), e(".header-smartClass .container > .logo-header .logo").attr("src", "images/logo.png"))
                                    : (t.removeClass("is-fixed"), e(".header-smartClass .container > .logo-header .logo").attr("src", "error-404.html"));
                            }
                        }),
                        r(),
                        ...
                        e(".scroll")
                            ...
                            .on("click", function (t) {
                                if ((t.preventDefault(), "" !== this.hash)) {
                                    ...
                                    var r = n - a;
                                    e("html, body").animate({ scrollTop: r }, 800, function () {});
                                }
                            }),
                        ...
                        e("#lightgallery").lightGallery({ selector: ".check-km", loop: !0, thumbnail: !0, exThumbImage: "data-exthumbimage" });
                },
                        ...
                        (function () {
                            if (jQuery("#masonry, .masonry").length) {
                                ...
                                if (jQuery(".card-container").length) {
                                    var i = void 0 === t.attr("data-column-width") ? "" : t.attr("data-column-width");
                                    "" != i && (i = parseInt(i)),
                                        t.imagesLoaded(function () {
                                            t.masonry({ columnWidth: i, gutterWidth: 15, isAnimated: !0, itemSelector: ".card-container" });
                                        });
                                }
                            }
    ...
    jQuery(document).ready(function () {
        jQuery(".owl-slider").owlCarousel({
            ...
            jQuery(".courses-carousel").owlCarousel({
                ...
                slideSpeed: 1500,
                navText: ['<i class="la la-arrow-left"></i>', '<i class="la la-arrow-right"></i>'],
                responsive: { 0: { items: 1 }, 480: { items: 2 }, 700: { items: 3 }, 1024: { items: 4 }, 1200: { items: 5 } },
            }),
            jQuery(".courses-carousel-2").owlCarousel({
                ...
                slideSpeed: 1500,
                navText: ['<i class="la la-arrow-left"></i>', '<i class="la la-arrow-right"></i>'],
                responsive: { 0: { items: 1 }, 480: { items: 1 }, 1024: { items: 3 }, 1200: { items: 3 } },
            }),
            ...
            jQuery(".client-logo-bx").owlCarousel({
                ...
                slideSpeed: 1500,
                navText: ['<i class="la la-arrow-left"></i>', '<i class="la la-arrow-right"></i>'],
                responsive: { 0: { items: 2 }, 480: { items: 4 }, 991: { items: 5 }, 1000: { items: 6 } },
            });
    });
})(jQuery);
        ...
        (window.verifyRecaptchaCallback = function (e) {
            ...
            t(".dzForm").on("submit", function (a) {
                ...
                t.ajax({
                    ...
                    dataType: "json",
                    success: function (a) {
                        1 == a.status && (e = '<div class="gen alert alert-success">' + a.msg + "</div>"),
                            0 == a.status && (e = '<div class="err alert alert-danger">' + a.msg + "</div>"),
                            t(".dzFormMsg").html(e),
                            t(".dzForm")[0].reset(),
                            grecaptcha.reset();
                    },
...
jQuery(document).ready(function () {
    "use strict";
    var a = { opacityIn: [0, 1], scaleIn: [0.2, 1], scaleOut: 3, durationIn: 800, durationOut: 600, delay: 500 };
    anime
        .timeline({ loop: !0 })
        .add({ targets: ".ml4 .letters-1", opacity: a.opacityIn, scale: a.scaleIn, duration: a.durationIn })
        .add({ targets: ".ml4 .letters-1", opacity: 0, scale: a.scaleOut, duration: a.durationOut, easing: "easeInExpo", delay: a.delay })
        .add({ targets: ".ml4 .letters-2", opacity: a.opacityIn, scale: a.scaleIn, duration: a.durationIn })
        .add({ targets: ".ml4 .letters-2", opacity: 0, scale: a.scaleOut, duration: a.durationOut, easing: "easeInExpo", delay: a.delay })
        .add({ targets: ".ml4 .letters-3", opacity: a.opacityIn, scale: a.scaleIn, duration: a.durationIn })
        .add({ targets: ".ml4 .letters-3", opacity: 0, scale: a.scaleOut, duration: a.durationOut, easing: "easeInExpo", delay: a.delay })
