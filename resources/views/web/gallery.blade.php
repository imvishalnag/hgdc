								...
								<li class="web design card-container col-lg-4 col-md-6 col-sm-6 wow zoomIn" data-wow-delay="0.2s">
									<div class="dlab-box frame-box m-b30">
										<div class="dlab-thum dlab-img-overlay1 "> 
											...
											<div class="overlay-bx">
												<div class="overlay-icon"> 
													<span data-exthumbimage="images/gallery/pic1.jpg" data-src="images/gallery/pic1.jpg" class="check-km" title="Image 7 Title will come here">
														<i class="fa fa-search icon-bx-xs"></i>
													</span> 
												</div>
											</div>
								...
								<li class="web design card-container col-lg-4 col-md-6 col-sm-6 wow zoomIn" data-wow-delay="0.4s">
									<div class="dlab-box frame-box m-b30">
										<div class="dlab-thum dlab-img-overlay1"> 
											...
											<div class="overlay-bx">
												<div class="overlay-icon"> 
													<span data-exthumbimage="images/gallery/pic2.jpg" data-src="images/gallery/pic2.jpg" class="check-km" title="Image 8 Title will come here">
														<i class="fa fa-search icon-bx-xs"></i>
													</span> 
												</div>
											</div>
								...
								<li class="web design card-container col-lg-4 col-md-6 col-sm-6 wow zoomIn" data-wow-delay="0.6s">
									<div class="dlab-box frame-box m-b30">
										<div class="dlab-thum dlab-img-overlay1"> 
											...
											<div class="overlay-bx">
												<div class="overlay-icon"> 
													<span data-exthumbimage="images/gallery/pic3.jpg" data-src="images/gallery/pic3.jpg" class="check-km" title="Image 9 Title will come here">
														<i class="fa fa-search icon-bx-xs"></i>
													</span> 
												</div>
											</div>
								...
								<li class="web design card-container col-lg-4 col-md-6 col-sm-6 wow zoomIn" data-wow-delay="0.2s">
									<div class="dlab-box frame-box m-b30">
										<div class="dlab-thum dlab-img-overlay1"> 
											...
											<div class="overlay-bx">
												<div class="overlay-icon"> 
													<span data-exthumbimage="images/gallery/pic4.jpg" data-src="images/gallery/pic4.jpg" class="check-km" title="Image 10 Title will come here">
														<i class="fa fa-search icon-bx-xs"></i>
													</span> 
												</div>
											</div>
								...
								<li class="web design card-container col-lg-4 col-md-6 col-sm-6 wow zoomIn" data-wow-delay="0.4s">
									<div class="dlab-box frame-box m-b30">
										<div class="dlab-thum dlab-img-overlay1"> 
											...
											<div class="overlay-bx">
												<div class="overlay-icon"> 
													<span data-exthumbimage="images/gallery/pic5.jpg" data-src="images/gallery/pic5.jpg" class="check-km" title="Image 11 Title will come here">
														<i class="fa fa-search icon-bx-xs"></i>
													</span> 
												</div>
											</div>
								...
								<li class="web design card-container col-lg-4 col-md-6 col-sm-6 wow zoomIn " data-wow-delay="0.6s">
									<div class="dlab-box frame-box m-b30">
										<div class="dlab-thum dlab-img-overlay1"> 
											...
											<div class="overlay-bx">
												<div class="overlay-icon"> 
													<span data-exthumbimage="images/gallery/pic6.jpg" data-src="images/gallery/pic6.jpg" class="check-km" title="Image 12 Title will come here">
														<i class="fa fa-search icon-bx-xs"></i>
													</span> 
												</div>
											</div>
